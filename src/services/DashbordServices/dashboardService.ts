...
export class DashboardService {
    ...
    url='api/pedido/dashboard';

    

    public async getBashboard(dashboard:IFilterDash) : Promise<IDashboard> {
        const response = await api.post(this.url, dashboard).then(response =>{
