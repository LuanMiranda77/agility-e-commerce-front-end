...
const Dashbord: React.FC = () => {
  ...
  const emogi = () => {
    ...
    { emogi: Utils.getEmogi()[4], text: 'Este mês a Loja fez poucas vendas sugiro reavaliar seu Marketing' }
    ];
    let messagem = null;
    ...
    if (((totalPedidosMes - totalPedidosMesPassado) / 1000) * 100 <= 25) {
      messagem = emo[1];
  ...
  const actionBodyTemplate = (rowData: any) => {
    return (
      <div className="buttonAction">
        <ButtonBase label="" icon="pi pi-pencil" className="p-button-rounded p-button-success p-mr-2 p-mb-2" onClick={() => detalhesMarktplace(rowData)} />
      </div>
    );
  }
  
  const totalizadorTable = () => {
  ...
  return <Container>
    ...
    <div className="p-grid  p-mb-2 p-col-12">
      <div className="p-col-9" style={{color: 'var(--text-title)'}}>
        <label>
    ...
    <div className='p-grid center p-mb-2 p-col-12'>
      <div className='p-col-12'>
        <div className='card-total p-mb-2 p-col-12 p-lg-12 p-xl-12 p-field'>
    ...
    <div className='p-grid center p-mb-2 p-col-12'>
      <div className='p-col-12 p-lg-4 p-xl-4'>
        <div className='card-total p-mb-2 p-field'>
    ...
    <div className='p-grid center p-mb-2 p-col-12'>
      <div className='p-col-12 p-lg-12 p-xl-12'>
        <div className='card-total p-field'>
          ...
          <div className="datatable-crud-demo datatable-responsive-demo">
            <div className="table">
              ...
              >
                <Column field="marketplace" header="Marketplace" body={bodyTemplateColumnA} headerStyle={{ width: '25%' }} sortable></Column>
                <Column field="finalizado" header="Finalizados" body={bodyTemplateColumnB} sortable headerStyle={{ width: '25%' }}></Column>
                <Column field="pago" header="Pagos" body={bodyTemplateColumnC} sortable headerStyle={{ width: '25%' }}></Column>
                <Column field="cancelado" header="Cancelados" body={bodyTemplateColumnD} sortable headerStyle={{ width: '25%' }}></Column>
